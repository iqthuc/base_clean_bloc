...
class LocalNotificationHelper {
  ...
  Future<InitializationSettings> _getPlatformSettings() async {
    const AndroidInitializationSettings initializationSettingsAndroid =
        AndroidInitializationSettings(NotificationConfig.notificationIconPath); //set notification icon
  ...
  Future<void> showNotification({
    ...
    final androidPlatformChannelSpecifics = AndroidNotificationDetails(
      ...
      color: Colors.blue, // initial colors
      vibrationPattern: vibrationPattern,
      // sound: RawResourceAndroidNotificationSound(
      //   notificationSoundPath.split('.').first,
      // ),
  ...
  Future<dynamic> onDidReceiveNotificationResponse(NotificationResponse response) async {
